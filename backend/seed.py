...
EQUIPMENT_DATA = [
    {"name": "Squat Rack", "type": "free_weight", "brand": None, "location_hint": "Free weight area"},
    {"name": "Smith Machine", "type": "machine", "brand": None, "location_hint": "Free weight area"},
    {"name": "Sled Leg Press", "type": "machine", "brand": None, "location_hint": "Leg area"},
    {"name": "V-Squat Machine", "type": "machine", "brand": None, "location_hint": "Leg area"},
    {"name": "Hack Squat", "type": "machine", "brand": None, "location_hint": "Leg area"},
    {"name": "Leg Curl Machine (Seated)", "type": "machine", "brand": None, "location_hint": "Leg area"},
    {"name": "Leg Curl Machine (Lying)", "type": "machine", "brand": "Panatta", "location_hint": "Leg area"},
    {"name": "Leg Extension Machine", "type": "machine", "brand": "Technogym", "location_hint": "Leg area"},
    {"name": "Hip Thrust Machine", "type": "machine", "brand": None, "location_hint": "Leg area"},
    {"name": "Flat Bench", "type": "free_weight", "brand": None, "location_hint": "Bench area"},
    {"name": "Incline Bench (Adjustable)", "type": "free_weight", "brand": None, "location_hint": "Bench area"},
    {"name": "Vertical Chest Press", "type": "machine", "brand": "Panatta", "location_hint": "Machine area"},
    {"name": "Machine Incline Press", "type": "machine", "brand": "Technogym", "location_hint": "Machine area"},
    {"name": "Cable Crossover Station", "type": "cable", "brand": None, "location_hint": "Cable area"},
    {"name": "Lat Pulldown Machine", "type": "cable", "brand": None, "location_hint": "Cable area"},
    {"name": "Seated Cable Row Station", "type": "cable", "brand": None, "location_hint": "Cable area"},
    {"name": "Plate-loaded Row", "type": "machine", "brand": "Panatta", "location_hint": "Machine area"},
    {"name": "Shoulder Press Machine", "type": "machine", "brand": "Technogym", "location_hint": "Machine area"},
    {"name": "Ab Machine", "type": "machine", "brand": "Technogym", "location_hint": "Core area"},
    {"name": "Lower Back Machine", "type": "machine", "brand": None, "location_hint": "Core area"},
    {"name": "Captain's Chair", "type": "bodyweight", "brand": None, "location_hint": "Core area"},
    {"name": "Dips Press Machine", "type": "machine", "brand": "Panatta", "location_hint": "Machine area"},
    {"name": "Preacher Curl Bench", "type": "free_weight", "brand": None, "location_hint": "Free weight area"},
    {"name": "Dumbbell Rack (5-30 kg)", "type": "free_weight", "brand": None, "location_hint": "Dumbbell area"},
    {"name": "Barbell + Plates", "type": "free_weight", "brand": None, "location_hint": "Free weight area"},
    {"name": "EZ Curl Bar", "type": "free_weight", "brand": None, "location_hint": "Free weight area"},
    {"name": "Cable Station (Multi)", "type": "cable", "brand": None, "location_hint": "Cable area"},
    {"name": "Stationary Bike", "type": "machine", "brand": None, "location_hint": "Cardio area"},
    {"name": "Resistance Bands", "type": "bodyweight", "brand": None, "location_hint": "Stretching area"},
    {"name": "Pull-up Bar", "type": "bodyweight", "brand": None, "location_hint": "Free weight area"},
]
